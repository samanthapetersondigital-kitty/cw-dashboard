...
const DATA = {
  ...
  finances: {
    ...
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 100.0, digital: 100.0 },
      { month: "2025-12", total: 325.0, digital: 325.0 },
      { month: "2026-02", total: 785.0, digital: 760.0 },
      { month: "2026-03", total: 70.0, digital: 70.0 },
      { month: "2026-04", total: 85.0, digital: 85.0 }
    ],
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Chris Ward — Digital Dashboard ({DATA.period})
      </h1>
